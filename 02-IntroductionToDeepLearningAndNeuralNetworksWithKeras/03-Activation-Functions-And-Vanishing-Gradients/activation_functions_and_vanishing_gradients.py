...
# ReLU derivative (ReLU gradient)
def relu_derivative(z):
    return np.where(z > 0, 1, 0)

# Define the number of input values -> generate 400 values between -10 and 10
# Generate a range of input values
z = np.linspace(-10, 10, 400)

# Compute the derivatives for Sigmoid and ReLU activations and assign the values
# to sigmoid_grad and relu_grad
sigmoid_grad = sigmoid_derivative(z)
relu_grad = relu_derivative(z)

# Visualize the sigmoid and relu activations and their gradients by plotting their output values
...
# Create the hyperbolic tangent function and it's derivative
def tanh(z):
    return np.tanh(z)
...
# Plot and compare the output of tanH fucntion with the ReLU function for 100 synthetic values between -5 and 5
