...
with zipfile.ZipFile(io.BytesIO(response.content)) as zip_ref:
    # Step 3: Iterate over the file in the ZIP
...
# Write a function that plots clustered locations and overlays then on a basemap
...
plot_clustered_locations(df, title='Museum Hierarchically Clustered by Proximity')