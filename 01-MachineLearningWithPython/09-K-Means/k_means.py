...
# k will range from 0-3, which will match the possible clusterss that each
# data point is in.
...
# Try to cluster the above dataset into a different number of clusters, say k = 3
...
# Try to cluster the above dataset into a different number of clusters, say k = 5
